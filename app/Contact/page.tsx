...
export default function Contact() {
  return (
    <div className="px-4 md:px-8 lg:px-16 bg-gray-50 min-h-screen py-16">
      <div className="max-w-7xl mx-auto mt-8">
        {/* Heading */}
        <div className="text-center mb-8">
          <h1 className="font-semibold text-2xl md:text-4xl text-gray-800">Get In Touch With Us</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            {/* Address Box */}
            <div className="flex items-start hover:shadow-lg transition-shadow duration-300">
          ...
          <div>
            <form className="space-y-6">
              ...
              <button className="w-full py-3 bg-primary text-white rounded-lg shadow bg-[#007580] hover:bg-[#005f6b] transition duration-300">Submit</button>
            </form>
          </div>
        </div>
        ...
        <div className="bg-gray-100 mt-16 py-10">
          <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
            {/* Feature Box 1 */}
            <div className="flex items-center hover:shadow-lg transition-shadow duration-300">
